...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2021 at 07:40 PM
...
(37, 'P-10001', '20210408030721_3055.png', '700', 3, 'กสิกรไทย', '2021-04-08 20:06:35', 'เลขที่ 1150 ต.ควนลัง อ.หาดใหญ่ จ.สงขลา 90000', 'ยืนยันแล้ว'),
...
INSERT INTO `tbl_shipment` (`sm_id`, `sm_company`, `sm_code`, `sm_date`, `sm_pm_code`, `sm_status`) VALUES
(6, 'Kerry Express', 'KR0542457864684', '2021-04-09 19:14:12', 'P-10001', 'จัดส่งแล้ว'),
(9, '', '', '', 'P-10002', 'รอดำเนินการ');
...
(3, 'm1', 'm1', 'สมชาย', 'อิอิ', 'ชาย', 'เลขที่ 1150 ต.ควนลัง อ.หาดใหญ่ จ.สงขลา 90000', 'test@test.com', '0811111111', 'member'),
(18, 'm2', 'm2', 'สมหญิง', 'อิอิ', 'หญิง', 'เลขที่ 112 ต.คลองแห อ.หาดใหญ่ จ.สงขลา 90110', 'm2@gmail.com', '0822222222', 'member');
...
--
ALTER TABLE `tbl_payment`
  MODIFY `pm_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `tbl_payment_list`
--
ALTER TABLE `tbl_payment_list`
  MODIFY `pl_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `tbl_shipment`
--
ALTER TABLE `tbl_shipment`
  MODIFY `sm_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tbl_user`
  MODIFY `u_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=20;
COMMIT;
