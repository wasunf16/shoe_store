...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2021 at 10:22 AM
...
(67, 'P-10010', '20210420032118_4696.jpg', '720', 3, NULL, '2021-04-20 15:21:11', 'เลขที่ 1150 ต.ควนลัง อ.หาดใหญ่ จ.สงขลา 90000', 'รอตรวจสอบ');
...
--
ALTER TABLE `tbl_payment`
  MODIFY `pm_id` int(50) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT for table `tbl_payment_list`
--
ALTER TABLE `tbl_payment_list`
  MODIFY `pl_id` int(50) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=88;
