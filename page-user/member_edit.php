...
if (isset($_POST['submit'])) {
    $obj = new Member();
    $result = $obj->memberEditByID($_POST['id'],$_POST['username'], $_POST['password'], $_POST['fname'], $_POST['lname'], $_POST['sex'], $_POST['address'], $_POST['email'], $_POST['tel']);
}

$obj = new Member();
$row = $obj->memberGetById($_GET['id']);
