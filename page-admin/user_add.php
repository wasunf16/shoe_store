...
if (isset($_POST['submit'])) {
    $obj = new User();
    $result = $obj->userAdd($_POST['username'],$_POST['password'],$_POST['fname'],$_POST['lname'],$_POST['sex'],$_POST['address'],$_POST['email'],$_POST['tel'],$_POST['role']);
    if($result == true){
                                ...
                                <div class="row">
                                    <form action="" method="POST" class="row g-3 col-md-12 mx-auto">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-check">
                                                <input name="role" value="admin" class="form-check-input" type="radio" id="admin" required>
                                                <label class="form-check-label" for="admin">
                                                    Admin
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input name="role" value="user" class="form-check-input" type="radio" id="user" checked required>
