                ...
                <div class="row">
                    <form action="" method="POST" class="row g-3 col-md-6 mx-auto">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="tel"  class="form-control" id="tel" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="10"  value="<?= $row_member[0]['u_tel'] ?>">
                        </div>
